...
export function PraevaSec17() {
	return (
		<section className="relative w-full bg-[#545c63] overflow-hidden min-[1200px]:min-h-[60.4em]">
			...
			<div
				...
				min-[1200px]:-translate-x-1/2 min-[1200px]:left-[calc(24%-3.72em)] min-[1200px]:top-[-2.11em] min-[1200px]:w-[19.49em] min-[1200px]:h-[11.11em]"
			>
				<Image
			...
			<RevealImage
				className="absolute z-[1] overflow-hidden pointer-events-auto
					...
					min-[1200px]:-left-14 min-[1200px]:top-[31.7em] min-[1200px]:w-[12.65em] min-[1200px]:h-[20.58em]"
				start="top 90%"
			>
				<Image
			...
			<RevealImage
				className="absolute z-[1] overflow-hidden pointer-events-auto
					...
					min-[1200px]:left-[78%] min-[1200px]:top-[5.77em] min-[1200px]:w-[19.24em] min-[1200px]:h-[16.68em]"
				start="top 90%"
			>
				<Image
			...
			<RevealImage
				className="absolute z-[1] overflow-hidden pointer-events-auto
					...
					min-[1200px]:right-auto min-[1200px]:bottom-auto min-[1200px]:-translate-x-1/2 min-[1200px]:left-[calc(77.5%+0.39em)] min-[1200px]:top-[53.04em] min-[1200px]:w-[11.16em] min-[1200px]:h-[10.08em]"
				start="top 90%"
			>
			...
			<div className="relative z-10 flex flex-col items-center pt-[5.77em] pb-[5.77em] pointer-events-none">
				<div className="w-full max-w-[28.86em] px-5 min-[1200px]:px-0 flex flex-col items-center gap-8 min-[1200px]:gap-[10.9em]">
