	...
	return (
		<section className="relative w-full bg-[#545c63] overflow-hidden min-[1440px]:min-h-[60.4em]">
			...
			<div
				...
				min-[1440px]:-translate-x-1/2 min-[1440px]:left-[calc(32.5%+0.18em)] min-[1440px]:top-[-2.11em] min-[1440px]:w-[19.49em] min-[1440px]:h-[11.11em]"
			>
				<Image src="/praeva/sec08/gallery-1.webp" alt="" fill className="object-cover" />
			...
			<RevealImage
				...
				start="top 90%"
			>
				<Image src="/shared/team-mask-2.webp" alt="" fill className="object-cover" />
			</RevealImage>
			...
			<RevealImage
				...
				start="top 90%"
			>
				<Image src="/praeva/sec08/gallery-2.webp" alt="" fill className="object-cover" />
			</RevealImage>
			...
			<div className="relative z-10 flex flex-col items-center pt-[5.77em] pb-[5.77em]">
							...
							<BlurReveal delay={0.05 + FEATURES.length * 0.07}>
								<div className="border-t border-[#808d95] pt-[1.65em] flex justify-center">
									<Button
										...
										size="badge"
										className="tracking-[-0.04em] opacity-80"
									>
