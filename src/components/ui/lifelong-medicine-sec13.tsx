			...
			<Container>
				<div className="flex flex-col items-center gap-10 md:gap-0">
					...
					<BlurReveal className="w-full flex justify-center">
						<h2 className="font-display text-[2.5rem] leading-[0.85] tracking-[0.025em] text-judge-gray text-center md:max-w-[39%]">
					...
					<div className="flex flex-col gap-10 w-full md:flex-row md:justify-between md:items-end">
						...
						<div className="flex flex-col gap-[4.8rem] md:w-[41%] md:pt-[8rem]">
							...
							>
								<Image
									src="/lifelong-medicine/sec13-runner.jpg"
							...
							<BlurReveal delay={0.1} className="flex flex-col gap-[4rem]">
								<p className="font-display italic text-[2.5rem] leading-[0.85] tracking-[0.025em] text-fire">
									It&rsquo;s memory. It&rsquo;s perspective.
								</p>
								<p className="font-display text-[2.5rem] leading-[0.85] tracking-[0.025em] text-judge-gray">
									It&rsquo;s a health team who carries the full arc of a
									person&rsquo;s health forward,{' '}
									<em className="font-display italic">year after year.</em>
								</p>
							</BlurReveal>
						</div>

						{/* RIGHT — taller portrait, bigger top offset */}
						<div className="md:w-[50%] md:pt-[13.1rem]">
							<RevealImage
								delay={0.1}
								className="relative w-full aspect-[680/642] overflow-hidden bg-bison-hide"
							>
								<Image
									src="/lifelong-medicine/sec13-woman.jpg"
